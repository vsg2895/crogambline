 ...
 */
export const alt = 'Crogambline — Time to Cash, Measured'
    ...
    (
      <div
        style={{
          ...
          background: 'linear-gradient(135deg, #140f22 0%, #221a3b 55%, #2e1f4d 100%)',
          color: '#efebff',
      ...
      >
        ...
        <div style={{ fontSize: 104, fontWeight: 700, marginTop: 24, textAlign: 'center', padding: '0 60px', color: '#7c5cff' }}>
          Crogambline
        </div>
